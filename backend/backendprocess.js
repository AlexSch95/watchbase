...
const movies = [
    ...
    {id: 2, title: "Schindler's List", rating: 9.0, year: 1993, genres: ["Biography","Drama","History","War"], director: "Steven Spielberg", actors: ["Liam Neeson", "Ben Kingsley", "Ralph Fiennes"], trailer: "https://www.youtube.com/watch?v=DxcSg6bL2Vg", shortDescription: "Oskar Schindler, a German industrialist and member of the Nazi party, tries to save his Jewish employees after witnessing the persecution of Jews in Poland during World War II."},
    ...
    {id: 4, title: "Scarface", rating: 8.3, year: 1983, genres: ["Crime","Drama","Thriller"], director: "Brian De Palma", actors: ["Al Pacino", "Michelle Pfeiffer", "Steven Bauer"], trailer: "https://www.youtube.com/watch?v=lU3EHVMkizc", shortDescription: "In 1980 Miami, a determined Cuban immigrant takes over a drug cartel and succumbs to greed."},
