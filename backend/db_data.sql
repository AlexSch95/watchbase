...
-- Django Unchained (id: 1)
(1, 10), (1, 4), (1, 12), -- Jamie Foxx, Christoph Waltz, Leonardo DiCaprio
-- Schindler's List (id: 2)
(2, 13), (2, 2), (2, 17), -- Liam Neeson, Ben Kingsley, Ralph Fiennes
-- Fight Club (id: 3)
(3, 3), (3, 8), (3, 9), -- Brad Pitt, Edward Norton, Helena Bonham Carter
-- Scarface (id: 4)
(4, 1), (4, 16), (4, 18), -- Al Pacino, Michelle Pfeiffer, Steven Bauer
-- Saving Private Ryan (id: 5)
(5, 20), (5, 14), (5, 21), -- Tom Hanks, Matt Damon, Tom Sizemore
-- Back to the Future (id: 6)
(6, 15), (6, 5), (6, 7), (6, 11), (6, 6), (6, 19), -- Michael J. Fox, Christopher Lloyd, Crispin Glover, Lea Thompson, Claudia Wells, Thomas F. Wilson
-- The Matrix (id: 7)
